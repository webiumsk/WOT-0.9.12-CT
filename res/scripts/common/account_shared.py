# 2015.11.10 21:31:20 Støední Evropa (bìžný èas)
...
def isValidClientVersion(clientVersion, serverVersion):
    if clientVersion != serverVersion:
        ...
        if clientPatchVersion < serverPatchVersion:
            return False
    return True
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\account_shared.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:31:21 Støední Evropa (bìžný èas)
