# 2015.11.10 21:31:40 Støední Evropa (bìžný èas)
...
def timetracked(func = None, context = None, timeLimit = DEFAULT_TIME_LIMIT, tickLength = DEFAULT_TICK_LENGTH):
    ...
    if func is not None:
        ...
        return decorator
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\common\time_tracking.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:31:41 Støední Evropa (bìžný èas)
