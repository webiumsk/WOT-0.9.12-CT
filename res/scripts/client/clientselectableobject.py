# 2015.11.10 21:24:23 Støední Evropa (bìžný èas)
...
class ClientSelectableObject(BigWorld.Entity):
    ...
    def collideSegment(self, startPoint, endPoint, skipGun = False):
        ...
        if collisions is None:
            ...
            return res
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\clientselectableobject.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:24:24 Støední Evropa (bìžný èas)
