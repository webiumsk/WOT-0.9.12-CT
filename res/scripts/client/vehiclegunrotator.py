# 2015.11.10 21:24:39 Støední Evropa (bìžný èas)
...
class _PlayerTurretRotationSoundEffect(CallbackDelayer):
    ...
    def __stopManualSoundCallback(self):
        self.__manualSound.stop()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\vehiclegunrotator.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:24:40 Støední Evropa (bìžný èas)
