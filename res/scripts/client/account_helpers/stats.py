# 2015.11.10 21:24:47 Støední Evropa (bìžný èas)
...
class Stats(object):
    ...
    def __berths_onShopSynced(self, callback, resultID, shopRev):
        if resultID < 0:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\account_helpers\stats.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:24:48 Støední Evropa (bìžný èas)
