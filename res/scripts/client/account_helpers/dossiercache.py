# 2015.11.10 21:24:44 Støední Evropa (bìžný èas)
...
class DossierCache(object):
    ...
    def __writeCache(self):
        ...
        if fileHandler is not None:
            fileHandler.close()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\account_helpers\dossiercache.pyc 
