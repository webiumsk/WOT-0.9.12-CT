# 2015.11.10 21:24:49 Støední Evropa (bìžný èas)
...
def migrateToVersion(fromVersion, core, data, callback = None):
    ...
    callback(data)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\account_helpers\settings_core\migrations.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:24:50 Støední Evropa (bìžný èas)
