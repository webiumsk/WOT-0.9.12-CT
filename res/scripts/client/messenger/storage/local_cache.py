# 2015.11.10 21:30:47 Støední Evropa (bìžný èas)
...
class StorageLocalCache(FileLocalCache):
    ...
    def _setCache(self, data):
        ...
        if version != _MESSENGER_CACHE_VERSION:
            return
        self._cache = cache
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\storage\local_cache.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:48 Støední Evropa (bìžný èas)
