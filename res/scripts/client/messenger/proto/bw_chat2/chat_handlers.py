# 2015.11.10 21:30:32 Støední Evropa (bìžný èas)
...
class AdminChatCommandHandler(provider.ResponseDictHandler):
    ...
    def _onResponseSuccess(self, ids, args):
        ...
        if cmd:
            g_messengerEvents.channels.onCommandReceived(cmd)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\proto\bw_chat2\chat_handlers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:33 Støední Evropa (bìžný èas)
