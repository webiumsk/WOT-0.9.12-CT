# 2015.11.10 21:30:34 Støední Evropa (bìžný èas)
...
class SearchUsersProcessor(SearchProcessor):
    ...
    def __um_onSearchTokenFailed(self, requestID, args):
        if self._lastRequestID == requestID:
            ...
            self._onSearchFailed(reason)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\proto\bw_chat2\search_processor.pyc 
