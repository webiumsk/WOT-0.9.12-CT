# 2015.11.10 21:30:30 Støední Evropa (bìžný èas)
...
class BWBattleTeamChannelFindCriteria(IEntityFindCriteria):
    ...
    def filter(self, channel):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\proto\bw\find_criteria.pyc 
