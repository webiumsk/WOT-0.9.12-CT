# 2015.11.10 21:30:44 Støední Evropa (bìžný èas)
...
class ContactsManager(ClientEventsHandler):
    ...
    def __ms_onUserPreferencesUpdated(self):
        self.__seq.release()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\proto\xmpp\contacts\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:45 Støední Evropa (bìžný èas)
