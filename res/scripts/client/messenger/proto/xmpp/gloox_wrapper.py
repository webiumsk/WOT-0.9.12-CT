# 2015.11.10 21:30:37 Støední Evropa (bìžný èas)
...
class ClientEventsHandler(ClientHolder):
    ...
    def unregisterHandlers(self):
        raise NotImplementedError
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\proto\xmpp\gloox_wrapper.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:38 Støední Evropa (bìžný èas)
