...
class WarningMessageFormatter(BaseMessageFormatter):
    ...
    def getFillColor(self):
        ...
        return fillColor
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\gui\scaleform\data\message_formatters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:21 Støední Evropa (bìžný èas)
