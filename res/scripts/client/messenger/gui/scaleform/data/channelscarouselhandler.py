# 2015.11.10 21:30:17 Støední Evropa (bìžný èas)
        ...
        if not clientID:
            ...
            if self.__guiEntry:
                ...
                if controller:
                    controller.exit()
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\gui\scaleform\data\channelscarouselhandler.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:18 Støední Evropa (bìžný èas)
