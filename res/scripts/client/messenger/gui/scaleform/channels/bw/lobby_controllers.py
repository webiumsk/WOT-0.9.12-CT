# 2015.11.10 21:30:16 Støední Evropa (bìžný èas)
...
class LobbyChannelController(_ChannelController):
    ...
    def __me_onUserActionReceived(self, _, user):
        if self._channel.hasMember(user.getID()):
            self._refreshMembersDP()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\gui\scaleform\channels\bw\lobby_controllers.pyc 
