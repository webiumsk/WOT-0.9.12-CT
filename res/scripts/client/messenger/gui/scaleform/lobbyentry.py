# 2015.11.10 21:30:14 Støední Evropa (bìžný èas)
    ...
    def __handleRqExitFromChannel(self, event):
        ...
        if clientID is None:
            ...
            if controller:
                controller.exit()
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\gui\scaleform\lobbyentry.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:15 Støední Evropa (bìžný èas)
