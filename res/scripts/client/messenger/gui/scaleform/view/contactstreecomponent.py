# 2015.11.10 21:30:24 Støední Evropa (bìžný èas)
...
class ContactsTreeComponent(ContactsTreeComponentMeta):
    ...
    def __onTotalStatusChanged(self):
        self._updateListState()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\gui\scaleform\view\contactstreecomponent.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:25 Støední Evropa (bìžný èas)
