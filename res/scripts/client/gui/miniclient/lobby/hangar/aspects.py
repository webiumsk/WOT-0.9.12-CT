# 2015.11.10 21:25:41 Støední Evropa (bìžný èas)
...
class EnableCrew(aop.Aspect):
    ...
    def atCall(self, cd):
        if g_currentVehicle.isPresent() and not self.__vehicle_is_available(g_currentVehicle.item):
            ...
            return None
            return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\miniclient\lobby\hangar\aspects.pyc 
