# 2015.11.10 21:26:01 Støední Evropa (bìžný èas)
...
class FalloutSquadActionValidator(SquadActionValidator):
    ...
    def _validateSlots(self, stats, flags, slots):
        ...
        return (True, UNIT_RESTRICTION.UNDEFINED)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\prb_control\restrictions\limits.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:26:02 Støední Evropa (bìžný èas)
