# 2015.11.10 21:25:56 Støední Evropa (bìžný èas)
...
class UnitFunctional(_UnitFunctional):
    ...
    def _isInCoolDown(self, requestType, callback = None, coolDown = None):
        if self._cooldown.validate(requestType, coolDown):
            ...
            return True
        return False
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\prb_control\functional\unit.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:25:58 Støední Evropa (bìžný èas)
