# 2015.11.10 21:25:52 Støední Evropa (bìžný èas)
...
class CompanyFunctional(PrbFunctional):
    ...
    def __companyExpiredCallback(self, _):
        ...
        if self.prbDispatcher._setRequestCtx(ctx):
            self.leave(ctx)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\prb_control\functional\company.pyc 
