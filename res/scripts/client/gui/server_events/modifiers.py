# 2015.11.10 21:28:55 Støední Evropa (bìžný èas)
...
def getModifierObj(name, params):
    if name in _MODIFIERS_DICT:
        ...
        return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\server_events\modifiers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:28:56 Støední Evropa (bìžný èas)
