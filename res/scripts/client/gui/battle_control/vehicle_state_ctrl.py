# 2015.11.10 21:25:19 Støední Evropa (bìžný èas)
...
def createCtrl(isReplayRecording):
    ...
    return ctrl
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\battle_control\vehicle_state_ctrl.pyc 
