# 2015.11.10 21:25:34 Støední Evropa (bìžný èas)
...
class BoostersController(Controller):
    ...
    def __clearBoosterTimeNotifyCallback(self):
        if self.__boosterNotifyTimeCallback is not None:
            ...
            self.__boosterNotifyTimeCallback = None
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\game_control\boosterscontroller.pyc 
