# 2015.11.10 21:28:31 Støední Evropa (bìžný èas)
...
class ITEM_TYPES(object):
    ...
    def shell_kindsabbreviation(key):
        ...
        if outcome not in ITEM_TYPES.SHELL_KINDSABBREVIATION_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\locale\item_types.pyc 
