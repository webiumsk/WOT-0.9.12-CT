# 2015.11.10 21:28:25 Støední Evropa (bìžný èas)
...
class DIALOGS(object):
    ...
    def all(key):
        ...
        if outcome not in DIALOGS.all_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\locale\dialogs.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:28:29 Støední Evropa (bìžný èas)
