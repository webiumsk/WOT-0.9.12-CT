# 2015.11.10 21:28:44 Støední Evropa (bìžný èas)
...
class WAITING(object):
    ...
    def titles(key):
        ...
        if outcome not in WAITING.TITLES_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\locale\waiting.pyc 
