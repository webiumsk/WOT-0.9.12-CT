# 2015.11.10 21:28:34 Støední Evropa (bìžný èas)
...
class SETTINGS(object):
    ...
    def keyboard_keysblocks_group(key):
        ...
        if outcome not in SETTINGS.KEYBOARD_KEYSBLOCKS_GROUP_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\locale\settings.pyc 
