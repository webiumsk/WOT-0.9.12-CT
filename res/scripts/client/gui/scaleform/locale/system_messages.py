# 2015.11.10 21:28:35 Støední Evropa (bìžný èas)
...
class SYSTEM_MESSAGES(object):
    ...
    def all(key):
        ...
        if outcome not in SYSTEM_MESSAGES.all_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\locale\system_messages.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:28:43 Støední Evropa (bìžný èas)
