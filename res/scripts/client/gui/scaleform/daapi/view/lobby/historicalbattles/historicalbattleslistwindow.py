# 2015.11.10 21:27:12 Støední Evropa (bìžný èas)
...
class HistoricalBattlesListWindow(HistoricalBattlesListWindowMeta, MethodsRules):
    ...
    def _getSelectedPriceIndex(self, prices):
        if self.priceIndex is not None:
            ...
            return len(prices) - 1
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\historicalbattles\historicalbattleslistwindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:13 Støední Evropa (bìžný èas)
