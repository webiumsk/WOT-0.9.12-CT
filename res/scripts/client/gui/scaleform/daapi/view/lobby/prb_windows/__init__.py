...
class _PrbPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __showCompanyMainWindow(self, event):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\prb_windows\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:20 Støední Evropa (bìžný èas)
