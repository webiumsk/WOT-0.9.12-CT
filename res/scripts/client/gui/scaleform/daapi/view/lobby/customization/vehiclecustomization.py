# 2015.11.10 21:26:40 Støední Evropa (bìžný èas)
...
class VehicleCustomization(VehicleCustomizationMeta, View):
    ...
    def dropCurrentItemInSection(self, section, kind):
        ...
        if g_currentVehicle.isLocked():
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\customization\vehiclecustomization.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:26:41 Støední Evropa (bìžný èas)
