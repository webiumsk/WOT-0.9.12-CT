...
class ActionButtonStateVO(dict):
    ...
    def getInvalidVehicleLevelsMessage(unitFunctional):
        ...
        return (stateString, {})
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\rally\actionbuttonstatevo.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:24 Støední Evropa (bìžný èas)
