# 2015.11.10 21:27:01 Støední Evropa (bìžný èas)
    ...
    def __getButtonData(self):
        if self.fortState.getStateID() == CLIENT_FORT_STATE.HAS_FORT:
            ...
            return (False,
             ...
             '',
             None)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\fortifications\components\fortbattlesintroview.pyc 
