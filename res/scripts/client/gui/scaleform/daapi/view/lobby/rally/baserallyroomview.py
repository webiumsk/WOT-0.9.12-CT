...
class BaseRallyRoomView(BaseRallyRoomViewMeta, UnitListener):
    ...
    def __handleCurrentVehicleChanged(self):
        self._setActionButtonState()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\rally\baserallyroomview.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:25 Støední Evropa (bìžný èas)
