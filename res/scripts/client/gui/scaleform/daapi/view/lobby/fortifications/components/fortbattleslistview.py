...
class FortBattlesListView(FortClanBattleListMeta, FortListener, UnitListener):
    ...
    def __updateSearchDP(self, state):
        if state.getStateID() != CLIENT_FORT_STATE.HAS_FORT:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\fortifications\components\fortbattleslistview.pyc 
