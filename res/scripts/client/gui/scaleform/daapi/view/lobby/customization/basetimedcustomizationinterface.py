# 2015.11.10 21:26:36 Støední Evropa (bìžný èas)
...
class BaseTimedCustomizationInterface(CustomizationInterface):
    ...
    def __handleRentalPackageChange(self, index):
        ...
        self._itemsDP.refresh()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\customization\basetimedcustomizationinterface.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:26:37 Støední Evropa (bìžný èas)
