# 2015.11.10 21:26:34 Støední Evropa (bìžný èas)
...
class VehicleSellDialog(VehicleSellDialogMeta):
    ...
    def __shopResyncHandler(self, reason, diff):
        ...
        if reason == CACHE_SYNC_REASON.SHOP_RESYNC or vehicle is not None and vehicle.rentalIsActive:
            self.onWindowClose()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\vehicleselldialog.pyc 
