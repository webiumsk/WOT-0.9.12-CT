# 2015.11.10 21:26:57 Støední Evropa (bìžný èas)
    ...
    def onBuildingChanged(self, buildingTypeID, reason, ctx = None):
        if reason == BUILDING_UPDATE_REASON.DELETED:
            ...
            if order.buildingID == buildingTypeID:
                self.destroy()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\fortifications\fortorderconfirmationwindow.pyc 
