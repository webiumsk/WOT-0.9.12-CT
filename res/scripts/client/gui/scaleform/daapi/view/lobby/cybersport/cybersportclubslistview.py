# 2015.11.10 21:26:44 Støední Evropa (bìžný èas)
...
class CyberSportClubsListView(CyberSportUnitsListMeta, UnitListener, ClubListener, ClubEmblemsHelper):
    ...
    def __getDetails(self, index):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\cybersport\cybersportclubslistview.pyc 
