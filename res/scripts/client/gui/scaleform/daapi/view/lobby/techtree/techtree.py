...
class TechTree(TechTreeMeta):
    ...
    def __handleReloadData(self, event):
        if event.key is Keys.KEY_R:
            ...
            self.as_refreshNationTreeDataS(SelectedNation.getName())
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\techtree\techtree.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:37 Støední Evropa (bìžný èas)
