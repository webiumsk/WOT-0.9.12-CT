# 2015.11.10 21:26:49 Støední Evropa (bìžný èas)
...
class ExchangeXPWindow(ExchangeXpWindowMeta):
    ...
    def __getActionStyle(self):
        ...
        if rate != actionRate and actionRate > 0:
            return 'statsText'
        return 'alertText'
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\exchange\exchangexpwindow.pyc 
