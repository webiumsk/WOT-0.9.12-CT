# 2015.11.10 21:26:29 Støední Evropa (bìžný èas)
...
class PersonalCaseDataProvider(object):
    ...
    def __roundByModulo(self, targetXp, rate):
        ...
        return targetXp
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\personalcase.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:26:30 Støední Evropa (bìžný èas)
