# 2015.11.10 21:27:30 Støední Evropa (bìžný èas)
...
class QuestsTileChainsView(QuestsTileChainsViewMeta):
    ...
    def __getChainUserName(self, chainID):
        ...
        if vehType is not None:
            ...
            return ''
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\server_events\queststilechainsview.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:31 Støední Evropa (bìžný èas)
