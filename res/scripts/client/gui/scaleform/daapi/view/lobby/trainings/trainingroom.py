# 2015.11.10 21:27:38 Støední Evropa (bìžný èas)
...
class TrainingRoom(LobbySubView, TrainingRoomMeta, PrbListener):
    ...
    def __me_onUserActionReceived(self, _, user):
        ...
        if playerInfo is None:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\trainings\trainingroom.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:39 Støední Evropa (bìžný èas)
