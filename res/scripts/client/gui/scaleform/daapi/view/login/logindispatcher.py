# 2015.11.10 21:27:40 Støední Evropa (bìžný èas)
...
class LoginDispatcher(DisposableEntity):
    ...
    def __doAutologin(self):
        ...
        self.onDoAutoLogin()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\login\logindispatcher.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:27:41 Støední Evropa (bìžný èas)
