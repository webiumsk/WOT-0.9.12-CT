# 2015.11.10 21:29:22 Støední Evropa (bìžný èas)
    ...
    def doAction(self):
        ...
        if vehicle is None:
            ...
            if not self.__isRemove and not newComponentItem.isInInventory:
                ...
                Waiting.hide('applyModule')
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\gui_items\items_actions\actions.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:29:23 Støední Evropa (bìžný èas)
