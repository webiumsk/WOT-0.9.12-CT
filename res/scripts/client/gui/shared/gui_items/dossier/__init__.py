# 2015.11.10 21:29:12 Støední Evropa (bìžný èas)
...
class ClubMemberDossier(_Dossier, stats.ClubMemberDossierStats):
    ...
    def _getDossierItem(self):
        return self
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\gui_items\dossier\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:29:13 Støední Evropa (bìžný èas)
