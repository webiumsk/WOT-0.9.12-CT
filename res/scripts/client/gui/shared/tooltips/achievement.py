# 2015.11.10 21:29:28 Støední Evropa (bìžný èas)
...
class GlobalRatingTooltipData(ToolTipBaseData):
    ...
    def getDisplayableData(self, *args):
        return {'name': makeString('#achievements:globalRating'),
         ...
         'isInDossier': True}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\tooltips\achievement.pyc 
