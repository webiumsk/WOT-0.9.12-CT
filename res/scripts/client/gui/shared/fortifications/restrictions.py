# 2015.11.10 21:29:07 Støední Evropa (bìžný èas)
...
class FortValidators(IFortValidators):
    ...
    def __validateFortPublicInfo(self, filterType, abbrevPattern):
        ...
        return (True, '')
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\fortifications\restrictions.pyc 
