# 2015.11.10 21:29:01 Støední Evropa (bìžný èas)
...
class RentLeftFormatter(object):
    ...
    def getRentBattlesLeftStr(self, localization = None, formatter = None):
        ...
        if battlesLeft > 0:
            ...
            return ''
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\formatters\time_formatters.pyc 
