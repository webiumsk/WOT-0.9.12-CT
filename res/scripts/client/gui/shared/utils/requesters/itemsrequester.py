# 2015.11.10 21:29:43 Støední Evropa (bìžný èas)
...
class ItemsRequester(object):
    ...
    def __getVehicleCDForTankman(self, tmanData):
        ...
        if vehData is not None:
            ...
            return set()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\utils\requesters\itemsrequester.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:29:44 Støední Evropa (bìžný èas)
