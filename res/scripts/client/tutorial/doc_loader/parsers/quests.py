# 2015.11.10 21:31:06 Støední Evropa (bìžný èas)
...
class QuestsChapterParser(ChapterParser):
    ...
    def __parseSharedVars(self, chapter):
        ...
        if filePath is None or not len(filePath):
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\tutorial\doc_loader\parsers\quests.pyc 
