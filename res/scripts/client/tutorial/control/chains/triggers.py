# 2015.11.10 21:30:59 Støední Evropa (bìžný èas)
...
class TankmanPriceDiscountTrigger(TriggerWithSubscription):
    ...
    def __onShopUpdated(self, _):
        self.toggle(isOn=self.isOn())
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\tutorial\control\chains\triggers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:31:00 Støední Evropa (bìžný èas)
