# 2015.11.10 21:30:57 Støední Evropa (bìžný èas)
    ...
    def __pe_onArenaPeriodChange(self, period, *args):
        if period is ARENA_PERIOD.BATTLE:
            ...
            if self.__isDelayPerformed():
                _leaveArena()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\tutorial\control\battle\functional.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:30:58 Støední Evropa (bìžný èas)
