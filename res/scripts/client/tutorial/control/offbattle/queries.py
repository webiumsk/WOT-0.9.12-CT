# 2015.11.10 21:31:01 Støední Evropa (bìžný èas)
...
class BattleResultMessage(ContentQuery):
    ...
    def invoke(self, content, varID):
        ...
        if descriptor is None:
            ...
            content['areAllBonusesReceived'] = descriptor.areAllBonusesReceived(self._bonuses.getCompleted())
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\tutorial\control\offbattle\queries.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:31:02 Støední Evropa (bìžný èas)
