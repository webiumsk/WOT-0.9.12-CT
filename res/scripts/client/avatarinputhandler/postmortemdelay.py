# 2015.11.10 21:25:01 Støední Evropa (bìžný èas)
...
class PostmortemDelay:
    ...
    def __cancelWait(self):
        if self.__cbIDWait is not None:
            ...
            self.__cbIDWait = None
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\avatarinputhandler\postmortemdelay.pyc 
