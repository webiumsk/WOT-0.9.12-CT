# 2015.11.10 21:32:31 Støední Evropa (bìžný èas)
...
def colourCorrectHSV():
    ...
    e.phases = [c, p]
    return e
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\postprocessing\effects\colourcorrect.pyc 
