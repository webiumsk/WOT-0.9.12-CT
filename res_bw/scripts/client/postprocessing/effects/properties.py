# 2015.11.10 21:32:33 Støední Evropa (bìžný èas)
...
class MaterialTextureProperty(MaterialProperty):
    ...
    def format(self, val):
        ...
        return filename
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\postprocessing\effects\properties.pyc 
