# 2015.11.10 21:32:34 Støední Evropa (bìžný èas)
...
def setShimmerStyle(h, style):
    ...
    if style == 0:
        ...
        m.uFixup = 0.0
        m.vFixup = 0.0
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\postprocessing\effects\shimmer.pyc 
