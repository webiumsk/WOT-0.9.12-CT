# 2015.11.10 21:32:18 Støední Evropa (bìžný èas)
...
def _niceFunctionString(f):
    if not (callable(f) or isinstance(f, types.GeneratorType) or isinstance(f, _BWCoroutineFunction)):
        ...
        return str(f)
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\helpers\bwcoroutine.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:32:19 Støední Evropa (bìžný èas)
