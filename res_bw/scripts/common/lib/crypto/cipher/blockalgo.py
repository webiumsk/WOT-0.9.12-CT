# 2015.11.10 21:34:42 Støední Evropa (bìžný èas)
...
class BlockAlgo:
    ...
    def decrypt_and_verify(self, ciphertext, mac_tag):
        ...
        self.verify(mac_tag)
        return pt
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\common\lib\crypto\cipher\blockalgo.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:34:43 Støední Evropa (bìžný èas)
