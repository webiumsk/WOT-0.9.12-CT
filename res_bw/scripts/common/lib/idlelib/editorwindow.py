# 2015.11.10 21:36:08 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 1:
        run(_Help_dialog)
    run(_Editor_window)
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\common\lib\idlelib\editorwindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.11.10 21:36:10 Støední Evropa (bìžný èas)
