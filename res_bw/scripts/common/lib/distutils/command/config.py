# 2015.11.10 21:35:16 Støední Evropa (bìžný èas)
...
def dump_file(filename, head = None):
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\common\lib\distutils\command\config.pyc 
