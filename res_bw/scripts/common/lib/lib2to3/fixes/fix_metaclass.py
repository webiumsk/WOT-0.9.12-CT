# 2015.11.10 21:36:57 Støední Evropa (bìžný èas)
...
class FixMetaclass(fixer_base.BaseFix):
    ...
    def transform(self, node, results):
        if not has_metaclass(node):
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\common\lib\lib2to3\fixes\fix_metaclass.pyc 
