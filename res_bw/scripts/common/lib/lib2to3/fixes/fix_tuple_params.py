# 2015.11.10 21:37:00 Støední Evropa (bìžný èas)
...
def tuple_name(param_list):
    ...
    return u'_'.join(l)
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\common\lib\lib2to3\fixes\fix_tuple_params.pyc 
