# 2015.11.10 21:37:42 Støední Evropa (bìžný èas)
...
def parse_file(fp):
    ...
    return exprlist
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\common\lib\plat-irix6\panelparser.pyc 
